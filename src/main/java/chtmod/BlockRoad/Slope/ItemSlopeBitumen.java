...
public class ItemSlopeBitumen extends Item {
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos,
		...
		for (int i = 0; i < 5; i++) {
			IBlockState ibs = bs[stack.getMetadata()].getDefaultState().withProperty(SlopeBitumen.PROPERTYLEVEL, i)
					.withProperty(SlopeBitumen.PROPERTYFACING, f).withProperty(SlopeBitumen.HEAD, i == 0);
