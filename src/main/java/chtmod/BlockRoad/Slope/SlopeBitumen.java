...
public class SlopeBitumen extends Block {
	...
	public SlopeBitumen(int arg0) {
		super(Material.ROCK);
		this.setCreativeTab(null);
		this.setUnlocalizedName("BlockSlopeBitumenV2" + arg0);
		this.setRegistryName("BlockSlopeBitumenV2" + arg0);
		this.setHardness(2);
		meta = arg0;
	}
	...
	public IBlockState getActualState(IBlockState state, IBlockAccess access, BlockPos pos) {
		...
		for (int i = 0; i < 5; i++) {
			...
			if (state1.getBlock() instanceof SlopeBitumen)
	...
	private void Delete(World world, BlockPos pos, IBlockState state) {
		...
		for (int i = 0; i < 5; i++) {
			...
			if (world.getBlockState(setpos).getBlock() instanceof SlopeBitumen)
