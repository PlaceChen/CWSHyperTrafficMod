...
public class ItemSignPlus extends Item {

	public ItemSignPlus() {
		this.setMaxStackSize(1);
		this.setUnlocalizedName("ItemSignPlus");
		this.setRegistryName("ItemSignPlus");
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos,
		...
		if (stack.hasTagCompound()) {
			if (worldIn.isAirBlock(p)) {
				worldIn.setBlockState(p, StartupCommon.sp.getDefaultState().withProperty(Sign.PROPERTYFACING, pf));
				try {
