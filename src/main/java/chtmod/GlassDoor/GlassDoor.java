...
public class GlassDoor extends Block {
	...
	private void open(BlockPos pos, World world) {
		...
		if (state.getBlock() instanceof GlassDoor) {
	...
	private void delete(BlockPos pos, World world) {
		if (world.getBlockState(pos.up()).getBlock() instanceof GlassDoor)
			world.setBlockToAir(pos.up());
		if (world.getBlockState(pos.down()).getBlock() instanceof GlassDoor)
