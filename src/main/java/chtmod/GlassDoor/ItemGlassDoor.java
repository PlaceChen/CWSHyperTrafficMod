...
public class ItemGlassDoor extends Item {
	...
	public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos,
		...
		IBlockState state = StartupCommon.gd0.getDefaultState().withProperty(GlassDoor.OPEN, false)
				.withProperty(GlassDoor.PROPERTYNS, f);
		boolean left = true;
		...
		for (int i = 1; i <= 2; i++)
			worldIn.setBlockState(pos.up(i),
					state.withProperty(GlassDoor.PROPERTYLAYER, i).withProperty(GlassDoor.LEFT, left));
