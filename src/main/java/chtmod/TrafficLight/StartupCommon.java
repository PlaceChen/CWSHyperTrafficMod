...
public class StartupCommon {
	public static TrafficLight[] tl = { new TrafficLight("B", 0), new TrafficLight("R", 0), new TrafficLight("T", 0),
			...
			new TrafficLight("Bike4", 10), new TrafficLight("Back", 1), new TrafficLight("Circle", 1),
			new TrafficLight("Circle1", 3), new TrafficLight("Circle2", 7), new TrafficLight("Circle3", 8),
			new TrafficLight("People", 1), new TrafficLight("People1", 5), new TrafficLight("People2", 6),
