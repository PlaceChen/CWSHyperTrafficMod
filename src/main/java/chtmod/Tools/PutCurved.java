...
import chtmod.RoadLines.Curved.LineMarker;
...
public class PutCurved extends Item {
	...
	public PutCurved(String arg0) {
		...
		this.setCreativeTab(chtmod.CwsCreativeTabs.toolTab);
	}
	...
	private void placeNormalRails(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, int i1,
		...
		worldIn.setBlockState(pos,
				chtmod.RoadLines.Curved.StartupCommon.lm.getDefaultState().withProperty(LineMarker.ROTATION, i1));
		...
		if (stack.getTagCompound() == null) {
			...
			int i2 = state.getValue(LineMarker.ROTATION);
	...
	public void onUpdate(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
		if (stack.getTagCompound() != null) {
			...
			if (!(worldIn.getBlockState(pos).getBlock() instanceof LineMarker))
				stack.setTagCompound(null);
		}
	}
}